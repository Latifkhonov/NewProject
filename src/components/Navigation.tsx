...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const renderMegaMenu = (items: any[]) => (
    <div className="absolute top-full left-0 mt-1 w-[800px] bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-2xl z-50 overflow-hidden">
      <div className="p-8">
        ...
        <div className="border-t border-gray-200 mt-6 pt-4 flex justify-between items-center">
          <p className="text-sm text-gray-600">Browse 500+ product categories</p>
  ...
  const renderDropdown = (items: any[]) => (
    <div className="absolute top-full left-0 mt-1 w-80 bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-2xl z-50 overflow-hidden">
      <div className="p-4">
  ...
  const renderMobileMenu = () => (
    <div className={`md:hidden fixed inset-0 z-50 transition-transform duration-300 ${
      ...
      <div className="bg-black/50 backdrop-blur-sm absolute inset-0" onClick={() => setIsMobileMenuOpen(false)} />
          ...
          <div className="space-y-2">
            {navigationItems.map((item) => (
              <div key={item.id} className="border-b border-gray-100 pb-2">
                <button className="w-full text-left p-3 text-gray-900 font-medium hover:bg-gray-50 rounded-lg">
                  {item.label}
                </button>
